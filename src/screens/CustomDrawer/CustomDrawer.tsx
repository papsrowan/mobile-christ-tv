    ...
    <View style={{ height: maxHeight }}>
      ...
      >
        <TouchableHighlight
          ...
          activeOpacity={0.9}
        >
          <Fa5Icon name="instagram" color={Colors.primary} size={20} />
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.socialLinks}
          underlayColor={"rgba(0,0,0,0)"}
          activeOpacity={0.9}
        >
          <Fa5Icon name="facebook" color={Colors.primary} size={20} />
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.socialLinks}
          underlayColor={"rgba(0,0,0,0)"}
          activeOpacity={0.9}
        >
          <Fa5Icon name="twitter" color={Colors.primary} size={20} />
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.socialLinks}
          underlayColor={"rgba(0,0,0,0)"}
          activeOpacity={0.9}
        >
          <Fa5Icon name="youtube" color={Colors.primary} size={20} />
        </TouchableHighlight>
      </View>
    </View>
  );
